...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/serkan/mandelbrot/src/main)
  set(main_DEVEL_PREFIX /home/serkan/mandelbrot/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/serkan/mandelbrot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/serkan/mandelbrot/src/main/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/serkan/mandelbrot/devel/lib;/home/serkan/mandelbrot/devel/lib;/home/serkan/catkin_ws/devel/lib;/opt/ros/melodic/lib)
